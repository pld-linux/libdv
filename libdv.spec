...
formatem stosowanym przez wiÍkszo∂Ê cyfrowych urz±dzeÒ, zwykle tych,
ktÛre uøywaj± interfejsu IEEE 1394 (FireWire/i.Link). libdv jest
pisany zgodnie z oficjalnymi standardami DV, IEC 61834, SMPTE 314M.

%package -n dv
Summary:	Programs to encode and play DV files
Summary(pl):	Programy do kodowania i odtwarzania plikÛw DV
...
Programy do kodowania i odtwarzania plikÛw DV.

%package devel
Summary:	DV library headers
Summary(pl):	Pliki nag≥Ûwkowe biblioteki DV
...
Pliki nag≥Ûwkowe potrzebne do budowania programÛw korzystaj±cych z
libdv.
